...
(7,'liyang','2019-05-30 16:18:59','你好'),
...
(1,'123','456454123'),
(2,'io','45477hfhghf'),
(3,'sdasad','(NULL)dsdsdsfsdgsffdadsa'),
(4,'www','sdasda');
...
CREATE TABLE `vblog_user` (
  ...
  `user_identity` int(11) NOT NULL DEFAULT '1',
...
insert  into `vblog_user`(`user_id`,`account`,`pwd`,`nickname`,`email`,`phone`,`signature`,`user_identity`,`ban`,`register_time`,`salt`,`avatar_lg`,`avatar_md`,`avatar_sm`) values 
(1,'2wenME_','123456','藏博鳌','1121899707@123.com','17863108186',NULL,1,0,'2019-06-02 15:23:19',1001,'','',''),
(2,'3wenME_','12345sss6','藏sdsds博鳌','112189s9707@123.com','17863108186',NULL,1,0,'2019-06-02 15:26:06',1001,'','',''),
(4,'3wenME_','12345sss6','藏sdsds博鳌','11218s9707@123.com','1786310s186',NULL,1,0,'2019-06-02 15:29:01',1001,'','','');
