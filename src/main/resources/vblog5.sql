...
insert  into `vblog_label`(`label_id`,`label_name`,`description`) values (1,'123','456454123'),(2,'io','45477hfhghf'),(3,'sdasad','(NULL)dsdsdsfsdgsffdadsa'),(4,'www','sdasda');
...
insert  into `vblog_token`(`user_id`,`token`,`create_time`,`expiry_time`) values (1,'3ccd68af8ae4bf1c31eb53656f4bbab5','2019-06-02 21:56:05','2019-06-29 21:56:23');
...
CREATE TABLE `vblog_user` (
  ...
  `avatar_md` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `avatar_sm` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
insert  into `vblog_user`(`user_id`,`account`,`pwd`,`nickname`,`email`,`phone`,`signature`,`allowance`,`ban`,`register_time`,`salt`,`avatar_lg`,`avatar_md`,`avatar_sm`) values (1,'2wenME_','123456','藏博鳌','1121899707@123.com','17863108186',NULL,1,0,'2019-06-02 15:23:19',1001,'','',''),(2,'3wenME_','12345sss6','藏sdsds博鳌','112189s9707@123.com','17863108186',NULL,1,0,'2019-06-02 15:26:06',1001,'','',''),(4,'3wenME_','12345sss6','藏sdsds博鳌','11218s9707@123.com','1786310s186',NULL,1,0,'2019-06-02 15:29:01',1001,'','',''),(18,'54412ffsdfg','8b0d0ef0aabb6cf58bf3ffb1047dfd01','藏dddd博鳌','9d07@123.com','1786310ss8186',NULL,1,0,'2019-06-04 00:13:09',5283,'sssssss','sssssss','rrrrrrrr');
...
insert  into `vblog_user_interest`(`user_id`,`label_id`) values (18,1),(18,2),(18,3);
